...
struct ArrowDirectionView: View {
    let course: Double
    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ...
            ZStack {
                ...
                TrueWindMarker(diameter: diameter, degree: trueWindDegree, windOffset: windOffset)
                
                ApparentWindMarker(diameter: diameter, degree: apparentWindDegree, windOffset: windOffset)
                
                Boom(diameter: diameter, degree: boomAngle, center: center)
                    .rotationEffect(Angle(degrees: -course))
